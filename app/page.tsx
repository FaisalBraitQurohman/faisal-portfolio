export default function Home() {
  return (
    <div className="min-h-screen bg-black text-white relative overflow-hidden">
      ...
      <div className="absolute bottom-40 left-20 w-3 h-3 bg-green-400 rounded-full animate-ping"></div>
      ...
      <div className="relative z-10 container mx-auto px-4 py-8">
        ...
        <header className="text-center mb-20 pt-16">
          ...
          <p className="text-2xl md:text-3xl text-purple-400 mb-8 font-medium">
          ...
          <div className="max-w-4xl mx-auto relative">
            ...
            {[
              ...
              <div key={index} className="relative mb-8">
                ...
                {/* Content - Positioned exactly beside the dot */}
                <div className={`absolute top-0 ${item.side === 'left' ? 'right-full pr-4 text-right' : 'left-full pl-4 text-left'}`}>
        ...
        <section className="text-center">
          ...
          <div className="flex justify-center space-x-6">
            <a
              href="mailto:faisalbraitqurohman@gmail.com"
              className="bg-gradient-to-r from-purple-600 to-blue-600 hover:from-purple-700 hover:to-blue-700 text-white px-8 py-4 rounded-full transition-all duration-300 hover:scale-105 font-medium"
            >
              Get In Touch
            </a>
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="border-2 border-gray-600 text-gray-300 hover:border-purple-500 hover:text-purple-400 px-8 py-4 rounded-full transition-all duration-300 hover:scale-105 font-medium"
            >
              View Code
            </a>
          </div>
